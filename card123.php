...
<div class="card-content__border borderWhite2">
	
	<div class="orderLeft">
		<div class="card-content__galery">
			<div class="rc5 main">
			...
			<?php
				...
				if ( !empty( $fotosRs ) ) {
					...
					<div class="rc5" style="background-color :#fff; width:115px; height:101px;float:left;">
						<center>
				...
				echo '<div style="clear:both;height:15px;" class="display-none"></div>';
			}
		...
		<?php
			...
			<div class="card-content__intruction">
				<div class="rc5">
	...
	<div class="orderText">
		<div style="float:left;">
			...
			<?php if ($uninumberNew && $f1=="1") {?> 
				...
				<?php }?>
				<div class="orderText__decription">
					<span class="textWhite">Описание</span><br><?=$about2?>
				</div>
				
				<div class="asortLeft orderText__price" style="width:100%; margin:21px 0 0 0; border-top:1px solid #fff;">
					...
					<?php if ($price < $oldPrice) {?>
						...
						<span class="discount"><?=intval(100-($price/$oldPrice*100))?>%</span><br>
						<span class="cina">Старая цена: </span>
						<span class="cina"><s><?=$oldPrice?> р.</s></span><br>
					<?php } ?>
					<span class="cina">Цена: </span>
					<span class="cina3b"><?=$price?> р.</span>
					...
					<div class="credit assort">
						<a href="#" onclick="cart_add_credit('<?=(($uninumberNew && $f1=="1")?$uninumberNew:$uninumber_n);?>', this);return false;">
							<span>В кредит</span>
							<svg preserveAspectRatio="none" viewBox="0 0 132 45">
								<g clip-path="url(.main-btn)" filter="url(#goo-big)">
					...
					<?
						if ($uninumberNew && $f1=="1") { ?>
						<div class="orderText__buy-buttons">
							<div class="buy">
								<a href="#" onclick="cart_add_form('<?=$uninumberNew;?>', this);return false; ">											<span>Купить</span>
									<svg preserveAspectRatio="none" viewBox="0 0 132 45">
										<g clip-path="url(.main-btn)" filter="url(#goo-big)">
											<circle class="top-left" cx="49.5" cy="-0.5" r="26.5" />
											<circle class="middle-bottom" cx="70.5" cy="40.5" r="26.5" />
							...
							<div class="buy quick">
								<a class="quick-by-click-btn" data-id="<?=$uninumberNew?>" <?=($share == 1?'data-share="1"':'')?> data-type="2">
							...
							<div class="buy rnp">
								<a class="rnp-btn" href="#" onclick="cart_add_rnp('<?=$uninumberNew;?>', this);return false;">
									<span>Заказ наложенным платежом</span>
									<svg preserveAspectRatio="none" viewBox="0 0 132 45">
										<g clip-path="url(.main-btn)" filter="url(#goo-big)">
											<circle class="top-left" cx="49.5" cy="-0.5" r="26.5" />
											<circle class="middle-bottom" cx="70.5" cy="40.5" r="26.5" />
							...
							<div class="credit r">
								<a href="#" onclick="cart_add_credit('<?=$uninumberNew;?>', this);return false;">
									<span>В кредит</span>
									<svg preserveAspectRatio="none" viewBox="0 0 132 45">
										<g clip-path="url(.main-btn)" filter="url(#goo-big)">
											<circle class="top-left" cx="49.5" cy="-0.5" r="26.5" />
								...
								?>
								<div class="buy">
									<a href="#" onclick="cart_add_form('<?=$uninumber_n;?>', this);return false; ">
										<span>Купить</span>
										<svg preserveAspectRatio="none" viewBox="0 0 132 45">
											<g clip-path="url(.main-btn)" filter="url(#goo-big)">
												<circle class="top-left" cx="49.5" cy="-0.5" r="26.5" />
								...
								<div class="buy quick">
									<a class="quick-by-click-btn" data-id="<?=$uninumber_n?>" <?=($share == 1?'data-share="1"':'')?> data-type="2">
										<span>Заказ в 1 клик</span>
										<svg preserveAspectRatio="none" viewBox="0 0 132 45">
											<g clip-path="url(.main-btn)" filter="url(#goo-big)">
												<circle class="top-left" cx="49.5" cy="-0.5" r="26.5" />
