...
document.write('<tr style="background:#72B1E7;font:12px Arial;color:#FFFFFF"><td align=center>П</td><td align=center>В</td><td align=center>С</td><td align=center>Ч</td><td align=center>П</td><td align=center>С</td><td align=center>В</td></tr>');
...
document.write('<tr><td colspan="7" align="center" style="cursor:pointer;font:13px Arial;background:#72B1E7" onclick="today()">Сегодня: '+addnull(sccd,sccm+1,sccy)+'</td></tr>');
	...
	for(var d=1;d<=42;d++)
	{
		...
		if ( ( d >= (cd -(-1) ) ) && ( d<=cd-(-marr[cm]) ) )
		{
			...
			if (sccm == cm && sccd == (d-cd) && sccy == cy)
				getObj('v'+parseInt(d)).style.color='#72B1E7';
